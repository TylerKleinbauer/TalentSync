...
from backend.apps.job_scraping.clean_jobs_db import clean_databases
from backend.apps.job_scraping.jobs_functions import scrape_and_store_jobs
from config.settings import DATABASES
from backend.apps.job_scraping.create_embeddings import embed_jobs
